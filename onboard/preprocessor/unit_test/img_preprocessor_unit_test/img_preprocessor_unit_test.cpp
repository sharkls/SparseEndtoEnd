...
TEST(ImgPreprocessorUnitTest, ImgPreprocessorFP32) {
  ...
  const std::vector<std::tuple<std::string, std::string>> test_samples{
      {"/share/Code/SparseEnd2End/script/tutorial/asset/sample_0_ori_imgs_1*6*3*900*1600_uint8.bin",
       "/share/Code/SparseEnd2End/script/tutorial/asset/sample_0_imgs_1*6*3*256*704_float32.bin"},
      {"/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_ori_imgs_1*6*3*900*1600_uint8.bin",
       "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_imgs_1*6*3*256*704_float32.bin"},
      {"/share/Code/SparseEnd2End/script/tutorial/asset/sample_2_ori_imgs_1*6*3*900*1600_uint8.bin",
