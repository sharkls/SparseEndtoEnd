...
TEST(Sparse4dHeadSecondFrameTrtInferUnitTest, TrtInferConsistencyVerification) {
  ...
  std::tuple<std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string,
      ...
      test_sample{
          ...
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_spatial_shapes_6*4*2_int32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_level_start_index_6*4_int32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_instance_feature_1*900*256_float32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_anchor_1*900*11_float32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_time_interval_1_float32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_temp_instance_feature_1*900*256_float32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_temp_anchor_1*900*11_float32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_mask_1*900_int32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_track_id_1*900_int32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_image_wh_1*6*2_float32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_lidar2img_1*6*4*4_float32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_track_id_1*900_int32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_pred_instance_feature_1*900*256_float32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_pred_anchor_1*900*11_float32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_pred_class_score_1*900*10_float32.bin",
          "/share/Code/SparseEnd2End/script/tutorial/asset/sample_1_pred_quality_score_1*900*2_float32.bin"};
