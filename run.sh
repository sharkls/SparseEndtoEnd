...
# 查看engine的耗时情况
/usr/src/tensorrt/bin/trtexec     --loadEngine=deploy/engine/sparse4dbackbone_int8.engine     --warmUp=200     --iterations=100     --duration=10     --useSpinWait
/usr/src/tensorrt/bin/trtexec     --loadEngine=deploy/engine/sparse4dhead1st_int8.engine     --warmUp=200     --iterations=100     --duration=10     --useSpinWait
/usr/src/tensorrt/bin/trtexec     --loadEngine=deploy/engine/sparse4dhead2nd_int8.engine     --warmUp=200     --iterations=100     --duration=10     --useSpinWait
