...
# -*- coding: utf-8 -*-
"""
比较GPU版本SparseBEV.cpp保存的各种输入数据与原始CPU版本数据的差异
...
def compare_time_interval():
    ...
    gpu_file = "/share/Code/Sparse4d/C++/Output/val_bin_gpu/sample_0_input_time_interval_1_float32.bin"
    cpu_file = "/share/Code/Sparse4d/C++/Output/val_bin/sample_0_input_time_interval_1_float32.bin"
...
def compare_image_wh():
    ...
    # 文件路径 - GPU版本 vs 原始CPU版本
    gpu_file = "/share/Code/Sparse4d/C++/Output/val_bin_gpu/sample_0_input_image_wh_1*6*2_float32.bin"
    cpu_file = "/share/Code/Sparse4d/C++/Output/val_bin/sample_0_input_image_wh_1*6*2_float32.bin"
    
    # 数据形状
    shape = (1, 6, 2)
    
    # 加载数据 - 注意GPU版本是int32，CPU版本是float32
    data1 = load_bin_file(gpu_file, shape, dtype=np.float32)
    data2 = load_bin_file(cpu_file, shape, dtype=np.float32)
    
    if data1 is not None and data2 is not None:
        # 将int32转换为float32进行比较
        data1_float = data1.astype(np.float32)
        stats = compare_data(data1_float, data2, "图像宽高")
...
def compare_lidar2img():
    ...
    # 文件路径 - GPU版本 vs 原始CPU版本
    gpu_file = "/share/Code/Sparse4d/C++/Output/val_bin_gpu/sample_0_input_lidar2img_1*6*4*4_float32.bin"
    cpu_file = "/share/Code/Sparse4d/C++/Output/val_bin/sample_0_input_lidar2img_1*6*4*4_float32.bin"
...
def compare_anchor():
    ...
    # 文件路径 - GPU版本 vs 原始CPU版本
    gpu_file = "/share/Code/Sparse4d/C++/Output/val_bin_gpu/sample_0_input_anchor_1*900*11_float32.bin"
    cpu_file = "/share/Code/Sparse4d/C++/Output/val_bin/sample_0_input_anchor_1*900*11_float32.bin"
...
def compare_spatial_shapes():
    ...
    # 文件路径 - GPU版本 vs 原始CPU版本
    gpu_file = "/share/Code/Sparse4d/C++/Output/val_bin_gpu/sample_0_input_spatial_shapes_6*4*2_int32.bin"
    cpu_file = "/share/Code/Sparse4d/C++/Output/val_bin/sample_0_input_spatial_shapes_6*4*2_int32.bin"
...
def compare_level_start_index():
    ...
    # 文件路径 - GPU版本 vs 原始CPU版本
    gpu_file = "/share/Code/Sparse4d/C++/Output/val_bin_gpu/sample_0_input_level_start_index_6*4_int32.bin"
    cpu_file = "/share/Code/Sparse4d/C++/Output/val_bin/sample_0_input_level_start_index_6*4_int32.bin"
...
def compare_instance_feature():
    ...
    # 文件路径 - GPU版本 vs 原始CPU版本
    gpu_file = "/share/Code/Sparse4d/C++/Output/val_bin_gpu/sample_0_input_instance_feature_1*900*256_float32.bin"
    cpu_file = "/share/Code/Sparse4d/C++/Output/val_bin/sample_0_input_instance_feature_1*900*256_float32.bin"
...
def main():
    ...
    # 保存详细结果到文件
    output_file = "gpu_vs_cpu_input_comparison_results.txt"
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write("=== GPU版本 vs CPU版本 输入数据比较结果 ===\n\n")
    ...
    # 特别说明GPU版本的特点
    print(f"\n=== GPU版本特点说明 ===")
    print("1. 所有数据都经过GPU内存处理")
    print("2. 数据保存路径: /share/Code/Sparse4d/C++/Output/val_bin_gpu/")
