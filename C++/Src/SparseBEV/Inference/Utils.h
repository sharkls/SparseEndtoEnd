...
Status getTopKTrackID(const std::vector<float>& confidence,  // Shape is (nums_anchors, )
...
Status getTopkInstance(const std::vector<float>& confidence,        // Shape is (num_querys, )
...
Status getTopKScores(const std::vector<float>& confidence,  // Shape is (nums_anchors, )
...
Status topK(const std::vector<float>& topk_cls_scores_origin,  // Shape is (topk, )
